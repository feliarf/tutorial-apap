...
// [favItems, setFavItems] = [state, setState]
    ...
    function handleItemClickFav(item) {
// immutability
...
// schedule to set a new state
    ...
    function handleItemClickProduct(item) {
// immutability
        const newItems = [...favItems];
        const newItem = { ...item };
// find index of item with id
    ...
    return (
        <div className="container-fluid">
            <h1 className="text-center">
                ...
                <h6><input type="checkbox"/>Show Favorit</h6>
            </h1>
                ...
                <div className="row">
                    <div className="col-sm">
                        <List
                            title="Our Menu"
                            items={dummyItems}
                            onItemClick={handleItemClickProduct}
                            type="hidden"
                        />
                    </div>
                    <div className="col-sm">
                        <List
                            title="My Favorite"
                            items={favItems}
                            onItemClick={handleItemClickFav}
                            type="checkbox"
                            Disusun oleh
                            WPR
                        />
